...
# modifiziert Montag, 27. April 2020 08:08 von Leander Jedamus
...
cd
tar cvfz $dir/dotfiles.tar.gz .env .exrc .vimrc .zshrc .cshrc .bashrc .login .zlogin .zlogout .zprofile .zsh_history .bash_logout .gitconfig .tmux.conf .condarc .condarc.example .forest_config .byobu .tmuxinator
